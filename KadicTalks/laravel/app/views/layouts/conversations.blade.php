...
<div class="content_row">
  <div class="content_row_container">
    ...
    <div class="post_info">
      <ul>
        <li class="first"><a href="post?id={{$conversation->id}}">{{(Post::where('conversation_id','=',$conversation->id)->count())}} replies</a></li>
        ...
        if ($post != NULL)
        {
          ...
          $name = $user->username;
          $time = UserController::TimeElapsed($post->created_at);
        }
        else
        {
          //no posts found in conversation
          $name = 'No Posts';
          $time = '00:00:00' ; 
        }
        ?>
